...
(function($){"use strict";$(function(){setTimeout(function(){$('.sp-container.sp-flat').each(function(){$(this).before('<div class="sp-btn-container"><button class="sp-btn"><i class="fa fa-eyedropper" aria-hidden="true"></i> Choose custom color</button></div>');$(this).hide();});},500);$(document).on('click','.sp-btn',function(){var $this=$(this),$con=$this.parent().next('.sp-container'),v=$this.html();$con.toggle(function(){if(v.indexOf('eyedropper')>=0){$this.addClass('active');$this.html('<i class="fa fa-times" aria-hidden="true"></i>').stop();}else{$this.removeClass('active');$this.html('<i class="fa fa-eyedropper" aria-hidden="true"></i> Choose custom color').stop();}});});});})(jQuery);
